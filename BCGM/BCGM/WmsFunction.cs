    ...
    class WmsFunction
    {
        ...
        public static string GetMenuClass(string cKey)
        {
            using (var cmd = new SqlCommand(@"select cClass from BFunction WHERE cFunction=@cFunction"))
            {
                ...
                var wf = new WmsFunction(Properties.Settings.Default.BCGM_2014ConnectionString);
        ...
        public static bool BoolCanOperate(string fCode,string fName)
        {
            ...
            using (var con = new SqlConnection(WmsLogin.WmsConstring))
            {
        ...
        {
            using (var con = new SqlConnection { ConnectionString = WmsLogin.WmsConstring })
            {
